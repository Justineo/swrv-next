...
- the docs light mode now uses a separate warm-paper / verdigris palette instead of the earlier white-and-Vue-green treatment, while dark mode keeps the Kong AI-connectivity palette
