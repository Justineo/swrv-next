...
- the docs site now uses default VitePress layout primitives, keeps the built-in code block treatment and highlighting, and themes the site through a smaller `--theme-*` source layer bridged into VitePress `--vp-*` variables plus the SWRV logo
