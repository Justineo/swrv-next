...
- Set `FORCE_JAVASCRIPT_ACTIONS_TO_NODE24=true` at workflow scope so GitHub sees the Node 24 opt-in before it initializes JavaScript actions such as `setup-vp`.
