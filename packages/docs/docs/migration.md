...
This repository is still in active rebuild mode. When behavior intentionally diverges from SWR or legacy SWRV, the design snapshot in `journey/design.md` should be treated as the current decision record.
